...
public class InsertionSort {
	 ...
	 * a performance � O(n), pois vai ter que iterar a lista mesmo que esteja 
	 * ordenada. 
	 * 
	 * No pior caso e na media, a performance ser� O(n�), pois ser� feito outro 
	 * loop quando o arr nao estiver ordenado para procurar a posicao correta. 
	 * 
	 * No insertionsort faz diferen�a ser ponteiro ou baseado em valor. 
	 * O ponteiro � mais rapido pois ocorre a substitui��o no valor do array. 
	 * 
	 * O principio dele � pegar um elemento por vez e comparar a um elemento do array. 
